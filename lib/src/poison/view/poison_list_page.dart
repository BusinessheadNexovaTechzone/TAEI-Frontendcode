...
class PoisonListPage extends StatefulWidget {
  final bool appBar;

  const PoisonListPage({super.key, this.appBar = true});

  @override
  State<PoisonListPage> createState() => _PoisonListPageState();
}

class _PoisonListPageState extends State<PoisonListPage> {
