...
class HangingSaveListPage extends StatefulWidget {
  final bool appBar;

  const HangingSaveListPage({super.key, this.appBar = true});

  @override
  State<HangingSaveListPage> createState() => _BurnListPageState();
}

class _BurnListPageState extends State<HangingSaveListPage> {
