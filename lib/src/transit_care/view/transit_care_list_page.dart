...
class TransitCarePage extends StatefulWidget {
  final bool isFromHome;

  const TransitCarePage({super.key, this.isFromHome = false});

  @override
  State<TransitCarePage> createState() => _TransitCarePageState();
}

class _TransitCarePageState extends State<TransitCarePage> {
