...
class BurnsSaveListPage extends StatefulWidget {
  final bool appBar;

  const BurnsSaveListPage({super.key, this.appBar = true});

  @override
  State<BurnsSaveListPage> createState() => _BurnsSaveListPageState();
}

class _BurnsSaveListPageState extends State<BurnsSaveListPage> {
