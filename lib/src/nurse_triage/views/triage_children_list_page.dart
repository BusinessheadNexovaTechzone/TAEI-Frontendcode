...
class TriageChildrenListPage extends StatefulWidget {
  final bool appBar;

  const TriageChildrenListPage({super.key, this.appBar = true});

  @override
  State<TriageChildrenListPage> createState() => _TriageChildrenListPageState();
}

class _TriageChildrenListPageState extends State<TriageChildrenListPage> {
