...
class ScriptSaveListPage extends StatefulWidget {
  final bool appBar;

  const ScriptSaveListPage({super.key, this.appBar = true});

  @override
  State<ScriptSaveListPage> createState() => _ScriptSaveListPageState();
}

class _ScriptSaveListPageState extends State<ScriptSaveListPage> {
