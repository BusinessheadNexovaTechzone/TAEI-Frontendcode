...
class CommonDateRangePicker1 extends StatefulWidget {
  ...
  @override
  State<CommonDateRangePicker1> createState() => _CommonDateRangePicker1State();
}

class _CommonDateRangePicker1State extends State<CommonDateRangePicker1> {
  ...
  Widget build(BuildContext context) {
    return Container(
      width: context.isDesktop ? 400 : null,

      // padding: EdgeInsets.only(
      //     top: 4, bottom: 4, left: 8, right: context.isDesktop ? 1 : 8),
...
//   final void Function(DateTime startDate, DateTime endDate)? onDateSelected;
//
//   const CommonDateRangePicker({super.key, this.onDateSelected});
//
//   @override
...
//     final now = DateTime.now();
//     final initialDate =
//         isStartDate ? startDate ?? now : endDate ?? startDate ?? now;
//     final firstDate = DateTime(now.year - 2);
//     final lastDate = DateTime(now.year + 2);
//
//     final picked = await showDatePicker(
