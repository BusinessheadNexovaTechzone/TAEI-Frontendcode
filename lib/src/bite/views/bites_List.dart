...
class BitesListPage extends StatefulWidget {
  final bool appBar;

  const BitesListPage({super.key, this.appBar = true});

  @override
  State<BitesListPage> createState() => _BitesListPageState();
}

class _BitesListPageState extends State<BitesListPage> {
