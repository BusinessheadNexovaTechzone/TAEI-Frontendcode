...
class TraumaTableScreen extends StatefulWidget {
  @override
  State<TraumaTableScreen> createState() => _TraumaTableScreenState();
}

class _TraumaTableScreenState extends State<TraumaTableScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        /// Get list safely
        final dataList = controller.traumaData.value?.data ?? [];
        if (dataList.isEmpty) {
