...
class StemiTableScreen extends StatefulWidget {
  @override
  State<StemiTableScreen> createState() => _StemiTableScreenState();
}

class _StemiTableScreenState extends State<StemiTableScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        /// Get list safely
        final dataList = controller.stemiData.value?.data ?? [];
        if (dataList.isEmpty) {
