...
class PoisonTableScreen extends StatefulWidget {
  @override
  State<PoisonTableScreen> createState() => _PoisonTableScreenState();
}

class _PoisonTableScreenState extends State<PoisonTableScreen> {
    ...
    return Scaffold(
      ...
      body: Obx(
        () {
          ...
          final dataList = controller.poisonData;
          if (dataList.isEmpty) {
