...
class StrokeTableScreen extends StatefulWidget {
  @override
  State<StrokeTableScreen> createState() => _StrokeTableScreenState();
}

class _StrokeTableScreenState extends State<StrokeTableScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        /// Get list safely
        final dataList = controller.strokeData.value?.data ?? [];
        if (dataList.isEmpty) {
