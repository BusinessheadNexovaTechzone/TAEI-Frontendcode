...
class PremSaveListPage extends StatefulWidget {
  final bool appBar;
  const PremSaveListPage({super.key, this.appBar = true});

  @override
  State<PremSaveListPage> createState() => _PremSaveListPageState();
}

class _PremSaveListPageState extends State<PremSaveListPage> {
                  ...
                  children: [
                    CommonDateRangePicker(
                      ...
                      onApply: () async {
                        ...
                        //   endDate: premController.premEndDate.toString(),
                        // );
                        premController.searchText.value = "0";
                        premController.isLoading(false);
                        //  filteredList = List.from(premController.ListData);
                        //setState(() {});
                      },
