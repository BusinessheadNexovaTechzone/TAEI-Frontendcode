...
class TraumaListPage extends StatefulWidget {
  final bool appBar;

  const TraumaListPage({super.key, this.appBar = true});

  @override
  State<TraumaListPage> createState() => _TraumaListPageState();
}

class _TraumaListPageState extends State<TraumaListPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      await traumaController.getTraumaDashboard(
        startDate: DateFormat('yyyy-MM-dd 00:00:00')
            .format(DateTime.now().subtract(Duration(days: 7))),
        endDate: DateFormat('yyyy-MM-dd 23:59:59').format(DateTime.now()),
      );
                          ...
                          child: Column(
                            ...
                            children: [
                              GridView.builder(
                                ...
                                itemCount:
                                    traumaController.traumaDataMap.length,
                                  ...
                                  return Container(
                                    ...
                                    child: Center(
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            traumaController.traumaDataMap.keys
                                                .elementAt(index),
